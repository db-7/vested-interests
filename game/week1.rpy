...
label w1tue:
    ...
    show nyx neu with dissolve
    n "I see a woman with pink hair and gold earrings running up to me."
    n "Jessica gives me an eager hug with a sweet smile on her face.'

    j "\"Oh! It's so good to see you! How long has it been? Two or three years?\""

    j "She quickly leads me to sit at a table with her."
    show nyx hap with dissolve
    n "I guess Jessica is still a bubbly whirlwind of energy. She's almost too much for me to keep up with."
    ...
    #idk what q is...
    n "I feel confused by her statement but I brush it off so I could ask a more important question."
    ...
    show jes neu with dissolve
    j "\"So there's Astin, Elias, Pierre, and Lucas. I think they're all pretty nice.\""
    j "\"Lucas is a bit closed off and Elias is kinda flirty. But Pierre is a gentleman and Astin's really funny.\""

    show nyx neu with dissolve
    n "I nod along as I listen to Jessica. They seem like people I could get along with."
    ...
    n "What the hell did she mean by my 'past'?"

    n "\"Excuse me?\""

    j "Jessica's smile becomes a bit sinister."
    ...
    show nyx neu with dissolve
    n "Oh... so that's how it is."
    n "Jessica is the same as ever."
    show nyx sch with dissolve
    n "I chuckle softly and smirk in amusement."
    ...
    show nyx hap with dissolve
    "\"It was nice catching up with you, Jess. You really haven't changed. Buy yourself something nice.\""
